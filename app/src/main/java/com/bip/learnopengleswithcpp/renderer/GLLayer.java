...
import com.bip.learnopengleswithcpp.utils.TextureHelper;
...
public class GLLayer implements GLSurfaceView.Renderer {
	...
	static public final int WARM= 1;
	static public final int VAN_GOGH = 2;
	static public final int MONET = 3;
	...
	protected String getVertexShader() {
		return GLToolbox.readTextFileFromRawResource(mActivityContext,
	...
	protected String getFragmentShader() {
		...
		switch (shader_selection){
			case WARM: id = R.raw.warm_fragment_shader; break;
			case VAN_GOGH: id = R.raw.van_fragment_shader;break;
			case MONET: id = R.raw.monet_fragment_shader;break;
		...
		return GLToolbox.readTextFileFromRawResource(mActivityContext, id);
	}
	...
	public void onDrawFrame(GL10 glUnused) {
		...
		final int vertexShaderHandle = GLToolbox.loadShader(
				GLES20.GL_VERTEX_SHADER, vertexShader);
		final int fragmentShaderHandle = GLToolbox.loadShader(
				GLES20.GL_FRAGMENT_SHADER, fragmentShader);

		mProgramHandle = GLToolbox.createAndLinkProgram(vertexShaderHandle,
