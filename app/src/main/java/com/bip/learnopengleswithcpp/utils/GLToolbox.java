...
package com.bip.learnopengleswithcpp.utils;
...
public class GLToolbox {
    private static final String TAG = "GLToolbox";
    ...
    public static String loadStringFromAssetFile(Context myContext, String filePath) {
